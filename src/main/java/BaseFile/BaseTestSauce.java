...
public class BaseTestSauce implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {

    public String seleniumURI = "@ondemand.saucelabs.com:80";
    public String buildTag = System.getenv("BUILD_TAG");
    public String username = "Nizze78";
    public String accesskey = "6d2ed7a0-4c99-47c2-a877-3c1d9d8baf1b";
    ...
    /**
     * Constructs a new {@link AndroidDriver} instance which i  s configured to use the capabilities defined by the browser,
    ...
    protected void createDriver(
        ...
        capabilities.setCapability("app", "sauce-storage:testApp.zip");
