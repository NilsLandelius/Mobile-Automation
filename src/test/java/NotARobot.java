...
public class NotARobot extends BaseChrome {
    public static void main(String[] args) throws MalformedURLException {
       ...
       //*******************************
        ...
        //The instance wd, will wait for a maximum of 5 seconds before giving up, if element is found before that
        //the test will continue through the code as soon as the element was found.
